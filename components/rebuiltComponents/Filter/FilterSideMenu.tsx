...
export default function FilterSideMenu({
	...
	return (
		<motion.div
			className='relative z-0 flex h-fit flex-row gap-2'
			variants={SideBarVariants}
			animate={isOpenFilter ? 'open' : 'closed'}
			initial='closed'
		>
			<div
				className='absolute flex flex-row gap-6'
			...
			>
				...
				windowWidth > breakpoints.md ? (
					<p className={'cursor-default truncate opacity-50'}>
			...
			<motion.div
				className={
					'absolute -right-6 -top-6 h-screen overflow-hidden backdrop-blur-md'
				}
