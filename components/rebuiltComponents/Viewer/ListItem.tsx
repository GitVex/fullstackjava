	...
	return (
		<div className='flex w-full flex-row items-center gap-2 rounded-lg bg-indigo-600/10 p-2 text-sm'>
			...
			<button
				...
				className='rounded bg-indigo-600/20 py-1 text-xs font-semibold text-white'
			>
				Copy
			</button>
			<button className='rounded bg-indigo-600/20 py-1 text-xs font-semibold text-white'>
				Add
			</button>
		</div>
	);
